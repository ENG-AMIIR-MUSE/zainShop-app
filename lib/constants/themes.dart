...
class appTheme {
  static const kBigTitle =
      TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: kWhiteColor);
  static const bodyText = TextStyle(fontSize: 12, color: kGray);

  static const headingOne =
      TextStyle(fontSize: 20, fontWeight: FontWeight.bold);
  static const headingTwo = TextStyle(fontSize: 14);
}
